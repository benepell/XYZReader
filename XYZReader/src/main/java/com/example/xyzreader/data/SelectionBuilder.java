...
public class SelectionBuilder {
     ...
     * Execute query using the current internal state as {@code WHERE} clause.
     */
    private Cursor query(SQLiteDatabase db, String[] columns, @SuppressWarnings("SameParameterValue") String groupBy,
                         @SuppressWarnings("SameParameterValue") String having, String orderBy, @SuppressWarnings("SameParameterValue") String limit) {
        assertTable();
